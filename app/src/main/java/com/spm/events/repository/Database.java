...
public class Database {
    ...
    // FILTER, 3
    public void filterWithOneFieldAndCompareGreater(String collectionName, String field1, Object filter1, String field2, Object filter2, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
    ...
    // FILTER, 4
    public void filterWithOneFieldAndCompareLess(String collectionName, String field1, Object filter1, String field2, Object filter2, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
