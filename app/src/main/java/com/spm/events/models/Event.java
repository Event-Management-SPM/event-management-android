package com.spm.events.models;

import static com.spm.events.UserMainActivity.decodeBase64;
...
public class Event implements Comparable<Event> {
    ...
    public Event(String addedBy, int attendeeCount, int checkInCount, Timestamp end, String image, String location, String name, String orgId, boolean posted, Timestamp start, int type, Map<String, Double> coordinates) {
